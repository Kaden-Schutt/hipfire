...
cases=(
    ...
    "24-tile6-lds-store-then-load-nextrow-read6 tile6_lds_store_then_load_nextrow_read6 full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "25-tile6-lds-store-then-load-separate-tile-read6 tile6_lds_store_then_load_separate_tile_read6 full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "26-tile6-lds-store-then-load-separate-readtile tile6_lds_store_then_load_separate_readtile full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "27-tile6-lds-forced-same-second-store tile6_lds_forced_same_second_store full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "28-tile6-lds-two-store-one-read tile6_lds_two_store_one_read full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "29-tile6-synth tile6_synth full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "30-tile6-synth-masked tile6_synth_masked full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "31-tile6-noglobal-nostore tile6 noglobal_nostore ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "32-tile6-aonly-nostore tile6 aonly_nostore ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "33-tile6-bonly-nostore tile6 bonly_nostore ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "34-tile6-nostore tile6 nostore ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "35-tile6-aonly tile6 aonly ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "36-tile6-bonly tile6 bonly ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "37-tile6-noglobal tile6 noglobal ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "38-tile6-full tile6 full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
)
