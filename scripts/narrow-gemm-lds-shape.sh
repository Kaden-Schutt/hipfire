...
cases=(
    ...
    "39-tile6-lds-load-then-store-dynamiccols-load4-consume4-pinned tile6_lds_load_then_store_dynamiccols_load4_consume4_pinned full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "40-tile6-lds-preloop-load-then-store-dynamiccols-load4-consume4-pinned tile6_lds_preloop_load_then_store_dynamiccols_load4_consume4_pinned full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "41-tile6-lds-store-then-load-dynamiccols-load4-nextrow-consume4-pinned tile6_lds_store_then_load_dynamiccols_load4_nextrow_consume4_pinned full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "42-tile6-lds-store-then-rowload-then-extra-load4-consume4-pinned tile6_lds_store_then_rowload_then_extra_load4_consume4_pinned full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "43-tile6-lds-store-then-rowload-barrier-noextra-load4-consume4-pinned tile6_lds_store_then_rowload_barrier_noextra_load4_consume4_pinned full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "44-tile6-lds-prestore-barrier-noextra-load4-consume4-pinned tile6_lds_prestore_barrier_noextra_load4_consume4_pinned full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "45-tile6-lds-preloop-barrier-noextra-load4-consume4-pinned tile6_lds_preloop_barrier_noextra_load4_consume4_pinned full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "46-tile6-lds-firstiter-barrier-noextra-load4-consume4-pinned tile6_lds_firstiter_barrier_noextra_load4_consume4_pinned full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "47-tile6-lds-single-store-prestore-barrier-noextra-load4-consume4-pinned tile6_lds_single_store_prestore_barrier_noextra_load4_consume4_pinned full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "48-tile6-lds-prestore-barrier-noextra-load3-consume3-pinned tile6_lds_prestore_barrier_noextra_load3_consume3_pinned full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "49-tile6-lds-betweenstore-barrier-noextra-load4-consume4-pinned tile6_lds_betweenstore_barrier_noextra_load4_consume4_pinned full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "50-tile6-lds-store-then-prerow-barrier-noextra-load4-consume4-pinned tile6_lds_store_then_prerow_barrier_noextra_load4_consume4_pinned full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "51-tile6-lds-store-then-rowload-barrier-gap-noextra-load4-consume4-pinned tile6_lds_store_then_rowload_barrier_gap_noextra_load4_consume4_pinned full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "52-tile6-lds-single-store-rowload-barrier-noextra-load4-consume4-pinned tile6_lds_single_store_rowload_barrier_noextra_load4_consume4_pinned full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "53-tile6-lds-store-then-rowload-barrier-noextra-load3-consume3-pinned tile6_lds_store_then_rowload_barrier_noextra_load3_consume3_pinned full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "54-tile6-lds-store-then-load-dynamiccols-load4-separate-tile-consume4-pinned tile6_lds_store_then_load_dynamiccols_load4_separate_tile_consume4_pinned full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "55-tile6-lds-store-then-load-nextrow-read6 tile6_lds_store_then_load_nextrow_read6 full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "56-tile6-lds-store-then-load-separate-tile-read6 tile6_lds_store_then_load_separate_tile_read6 full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "57-tile6-lds-store-then-load-separate-readtile tile6_lds_store_then_load_separate_readtile full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "58-tile6-lds-forced-same-second-store tile6_lds_forced_same_second_store full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "59-tile6-lds-two-store-one-read tile6_lds_two_store_one_read full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "60-tile6-synth tile6_synth full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "61-tile6-synth-masked tile6_synth_masked full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "62-tile6-noglobal-nostore tile6 noglobal_nostore ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "63-tile6-aonly-nostore tile6 aonly_nostore ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "64-tile6-bonly-nostore tile6 bonly_nostore ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "65-tile6-nostore tile6 nostore ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "66-tile6-aonly tile6 aonly ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "67-tile6-bonly tile6 bonly ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "68-tile6-noglobal tile6 noglobal ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "69-tile6-full tile6 full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
)
