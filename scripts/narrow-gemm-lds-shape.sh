...
cases=(
    ...
    "43-tile6-lds-store-then-load-dynamiccols-load4-separate-tile-consume4-pinned tile6_lds_store_then_load_dynamiccols_load4_separate_tile_consume4_pinned full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "44-tile6-lds-store-then-load-nextrow-read6 tile6_lds_store_then_load_nextrow_read6 full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "45-tile6-lds-store-then-load-separate-tile-read6 tile6_lds_store_then_load_separate_tile_read6 full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "46-tile6-lds-store-then-load-separate-readtile tile6_lds_store_then_load_separate_readtile full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "47-tile6-lds-forced-same-second-store tile6_lds_forced_same_second_store full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "48-tile6-lds-two-store-one-read tile6_lds_two_store_one_read full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "49-tile6-synth tile6_synth full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "50-tile6-synth-masked tile6_synth_masked full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "51-tile6-noglobal-nostore tile6 noglobal_nostore ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "52-tile6-aonly-nostore tile6 aonly_nostore ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "53-tile6-bonly-nostore tile6 bonly_nostore ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "54-tile6-nostore tile6 nostore ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "55-tile6-aonly tile6 aonly ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "56-tile6-bonly tile6 bonly ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "57-tile6-noglobal tile6 noglobal ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
    "58-tile6-full tile6 full ${LAUNCHES} ${M} ${N} ${K} ${K_LIMIT}"
)
