...
Cohesion: 0.03
Nodes (81): main(), HfqTensor, arg_value(), awq_eligible(), awq_scales_to_f16_bytes(), bf16_colnorm2(), bf16_to_f32(), f32_slice_to_bf16_bytes() (+73 more)
...
Cohesion: 0.10
Nodes (32): dflash_contract_accepts_matching_lfm2_shape(), dflash_contract_rejects_bad_target_layers(), dflash_contract_rejects_hidden_vocab_and_mask_mismatch(), draft_cfg(), greedy_acceptance(), greedy_acceptance_accepts_prefix_and_uses_rejection_row_bonus(), greedy_acceptance_full_accept_uses_tail_row_bonus(), greedy_acceptance_rejects_first_draft_and_uses_row0_bonus() (+24 more)
...
Cohesion: 0.07
Nodes (38): GemmFamily, GemmFamily::registry(), GemmFamily::run(), GemmFamily::run_key(), GemmParams, Run a GEMM operation against an *explicit* [`KernelKey`], bypassing the dtype-ke, GEMM kernel family: dispatching batched matrix-matrix multiply across quant form, Run a GEMM operation. Validates arch compatibility via `resolve()`, then dispatc (+30 more)
...
Cohesion: 0.20
Nodes (20): diff_stats_json(), ROCm backend contracts and evidence adapters. This crate intentionally does not , dense_ffn_rocm_output_records_device_and_kernel_path(), DiffStats, rocm_backend_path_for_selected_backend(), rocm_dense_ffn_module_contract(), rocm_dense_ffn_module_output(), rocm_device_identity() (+12 more)
...
Cohesion: 0.29
Nodes (8): aspect_scaled_dimension(), DiffusionTxt2ImgArgs, generate_highres_txt2img(), highres_first_pass_dimensions(), highres_second_pass_init_image(), highres_second_pass_init_image_cover_crops_exact_resize(), highres_target_dimensions(), scaled_highres_dimension()
