...
| Model tags, VRAM, registry files | [`cli/registry.json`](../../../cli/registry.json), [`docs/MODELS.md`](../../../docs/MODELS.md) |
...
```bash
hipfire diag
hipfire pull qwen3.5:4b          # tag from cli/registry.json; other tags OK if VRAM fits
...
| LFM2.5 chat / thinking frame | `python3 scripts/lfm_serve_harness.py --model <path> --tag lfm2.5:…` |
...
| Production-path throughput report | Daemon `done` fields (`prefill_tok_s`, `decode_tok_s`, `ttft_ms`) or `cli/bench_sweep.ts` per [`docs/methodology/perf-benchmarking.md`](../../../docs/methodology/perf-benchmarking.md) and [`docs/methodology/bench-suite.md`](../../../docs/methodology/bench-suite.md) |
