...
| **Serve semantics (if user-visible)** | `scripts/serve_harness.py` with the exact model; LFM chat/thinking → `scripts/lfm_serve_harness.py` | Finish reasons, empty/runaway, timing hooks, LFM framing | Numerical parity; Redline proof |
