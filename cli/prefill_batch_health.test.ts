...
describe("prefill batch health payload", () => {
  ...
  test("includes serialized batching metadata when enabled", () => {
    expect(buildPrefillBatchHealthPayload({
      ...
      queueSize: 5,
      pendingRequests: 1,
      residentRuntimeSessions: 5,
      residentDecodeSessions: 2,
      residentCheckpoints: 3,
      ...
      queue_size: 5,
      pending_requests: 1,
      resident_runtime_sessions: 5,
      resident_decode_sessions: 2,
      resident_checkpoints: 3,
      resident_checkpoint_max: 4,
      resident_state_cache: true,
