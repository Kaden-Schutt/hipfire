...
// Canonical CPU half<->f32 conversions live in rdna_compute::fp16. Re-exported
// so the bare f16_to_f32 / bf16_to_f32 / f32_to_f16 call sites stay unchanged.
use rdna_compute::{bf16_to_f32, f16_to_f32, f32_to_f16};
