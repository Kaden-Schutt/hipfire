...
//! Typed, immutable env-var resolution for hipfire-rdna.
//!
...
pub struct FeatureFlags {
    ...
    pub conv1d_tree_gfx1151: Option<bool>,
...
impl FeatureFlags {
    pub fn from_env(arch: &str) -> Self {
        ...
        Self {
            ...
            // parity; default keeps existing fast routing.
            hfq4_gate_up_fast: std::env::var("HIPFIRE_HFQ4_GATE_UP_FAST").as_deref() != Ok("0"),
            ...
            conv1d_tree_gfx1151: parse_bool("HIPFIRE_CONV1D_TREE_GFX1151"),
