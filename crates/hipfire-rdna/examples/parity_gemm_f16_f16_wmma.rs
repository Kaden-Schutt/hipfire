...
//!
//!   cargo run -p hipfire-rdna --example parity_gemm_f16_f16_wmma [M K B]
...
fn main() {
    ...
    if !gpu.arch_caps.has_wmma_w32() {
        println!(
            "SKIP gemm_f16_f16_wmma parity: {} lacks wave32 WMMA",
            gpu.arch
        );
        return;
    }
    ...
    gpu.gemm_f16_f16_wmma(&a_dev, &x_dev, &y_dev, m, k, b)
        .unwrap();
