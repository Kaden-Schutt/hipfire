...
fn launch_wmma(
    gpu: &Gpu,
    a_q8: &hipfire_rdna::GpuTensor,
    x_f16: &hipfire_rdna::GpuTensor,
    y_f32: &hipfire_rdna::GpuTensor,
    m: usize,
    k: usize,
    n: usize,
) {
...
// Inline f32→f16 bit conversion (hipfire-rdna can't depend on hipfire-runtime).
