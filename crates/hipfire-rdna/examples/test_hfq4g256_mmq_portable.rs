...
//! whatever GPU `hipfire_rdna::Gpu::init()` brings up. Cross-checks both MMQ
...
fn check_shape(gpu: &mut hipfire_rdna::Gpu, m: usize, k: usize, n: usize) -> Result<(), Outcome> {
    ...
    let d_y_add = gpu
        .zeros(&[n * m], hipfire_rdna::DType::F32)
