...
pub const ENV_HF_HOME: EnvVarDoc = EnvVarDoc {
    ...
    source: "crates/hipfire-server/src/routes/sdapi.rs:3316",
};
...
pub const ENV_HIPFIRE_TINY_SD_HFQ: EnvVarDoc = EnvVarDoc {
    ...
    source: "crates/hipfire-server/src/routes/sdapi.rs:3489",
};
...
pub const ENV_HUGGINGFACE_HUB_CACHE: EnvVarDoc = EnvVarDoc {
    ...
    source: "crates/hipfire-server/src/routes/sdapi.rs:3319",
};
