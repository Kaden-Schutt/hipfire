...
impl Gpu {
    ...
    pub fn gemv_hfq4g256_residual(
        ...
        static GFX1201_27B_RESIDUAL_K6144: OnceLock<bool> = OnceLock::new();
        let gfx1201_27b_residual_k6144 = gfx1201_27b_global
            && k == 6_144
            && *GFX1201_27B_RESIDUAL_K6144.get_or_init(|| {
                std::env::var("HIPFIRE_GFX1201_HFQ4_27B_RESIDUAL_K6144").as_deref() == Ok("1")
            });
        let (src, module, func_name) = if gfx1201_27b_residual_k6144 {
            (
