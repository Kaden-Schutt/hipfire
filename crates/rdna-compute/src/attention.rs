...
impl Gpu {
    ...
    pub fn attention_q8_0_kv(
        ...
        // Captured decode/proposal graphs outlive these stack-backed scalar
        // arguments. Retain an owned kernarg blob for graph replay instead of
        // leaving HIP graph nodes with dangling kernelParams pointers.
        let result = self.launch_maybe_blob(
            "attention_q8_0_kv",
            [n_heads as u32, 1, 1],
            [block_size, 1, 1],
