...
pub fn gemv_mq4g256_lloyd_for_arch(arch: &str) -> (&'static str, &'static str) {
    ...
    if std::env::var("HIPFIRE_LLOYD_FORCE_BASELINE")
        .ok()
        .as_deref()
        == Some("1")
    {
...
/// HFQ3/MQ3-G256 analogue of `gemv_hfq4g256_residual_sigmoid_scaled_gpu_batched`.
/// Used by gfx1151 MQ3 MoE shared-expert `down` in batched prefill.
...
/// gfx1151 HFQ6/MQ6 sister of GEMM_HFQ4G256_MOE_GROUPED_WMMA_K2_SRC.
/// Uses the gfx11 wave32 WMMA ABI with HFQ6's 200 B/group dequant layout.
...
/// gfx1151 (RDNA3.5) HFQ3/MQ3 sister of GEMM_HFQ4G256_MOE_GROUPED_WMMA_K2_SRC.
/// Uses the gfx11 wave32 WMMA ABI (`_w32`, half16 operands) with HFQ3's
/// 104 B/group dequant layout.
