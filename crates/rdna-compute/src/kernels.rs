...
pub const GEMV_MQ4G256SEL_SRC: &str = include_str!("../../../kernels/src/gemv_mq4g256sel.hip");
pub const GEMV_MQ4G256SEL_MULTIROW_SRC: &str =
    include_str!("../../../kernels/src/gemv_mq4g256sel_multirow.hip");
