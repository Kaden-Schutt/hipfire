...
pub const GEMM_MFP4G32_E8_SOA_GROUPED_WMMA_B4_GFX1151_SRC: &str = concat!(
    "#define E8_GROUPED_PREFILL_BATCH_TILES 4\n",
    "#define E8_GROUPED_PREFILL_KERNEL_NAME gemm_mfp4g32_e8_soa_grouped_wmma_b4_gfx1151\n",
    include_str!("../../../kernels/src/gemm_mfp4g32_e8_soa_grouped_wmma.gfx1151.hip")
);
