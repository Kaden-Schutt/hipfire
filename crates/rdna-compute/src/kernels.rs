...
/// Exact dense Qwen3.5-27B gfx1201 attention-output residual. K=6144 is 24
/// HFQ4 groups (six group-quads), with no generic tail.
pub const GEMV_HFQ4G256_RESIDUAL_K6144_GLOBAL_GFX1201_SRC: &str = concat!(
    "#define HIPFIRE_GFX12_WEIGHT_GLOBAL_LOADS 1\n",
    "#define HIPFIRE_RESIDUAL_GROUPS_PER_ROW 24\n",
    "#define HIPFIRE_RESIDUAL_KERNEL gemv_hfq4g256_residual_k6144_global_gfx1201\n",
    "#define HIPFIRE_GFX12_WEIGHT_CACHE_ELIGIBLE 1\n",
    include_str!("../../../kernels/src/gfx12_weight_cache_policy.inc"),
    include_str!("../../../kernels/src/gemv_hfq4g256_residual.hip")
);
