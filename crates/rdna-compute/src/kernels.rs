...
/// Product-semantics independent-row sampler: one workgroup per lane, with
/// per-lane RNG and repeat/presence/frequency penalties.
pub const SAMPLE_ROWS_PF_SRC: &str =
    include_str!("../../../kernels/src/sample_rows_pf.hip");
