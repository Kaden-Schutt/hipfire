...
fn pointer_effects(kernel: &str) -> Option<Vec<PointerEffect>> {
    ...
    match kernel {
        ...
        | "fused_qkvza_mq4g256v2_k2048_ldsx8_gfx1100" => Some(vec![
            read(0),
            read(8),
            read(16),
            read(24),
...
mod tests {
    ...
    fn fused_qkvza_mq4g256v2_keeps_exact_scalar_replay_contract() {
        ...
        // Generic, gfx1100 K=2048 HOIST_X32, and LDSX8 share the same 14-arg ABI:
        ...
        // Identities stay independent: hoist/ldsx8 never collapse onto generic or each other.
        assert_ne!(
            "fused_qkvza_mq4g256v2_k2048_hoist_x32_gfx1100",
            "fused_qkvza_mq4g256v2"
        );
