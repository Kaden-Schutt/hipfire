...
impl ArchCaps {
    pub fn new(arch: &str, flags: std::sync::Arc<FeatureFlags>) -> Self {
        ...
        let is_rdna3     = is_gfx1100 || is_gfx1101 || is_gfx1102 || is_gfx1103
                        || is_gfx1150 || is_gfx1151 || is_gfx1152;
        ...
        Self {
            arch: arch.to_string(),
            is_gfx906, is_gfx908, is_gfx1010, is_gfx1011, is_gfx1012,
            is_gfx1030, is_gfx1031, is_gfx1032,
            is_gfx1100, is_gfx1101, is_gfx1102, is_gfx1103,
            is_gfx1150, is_gfx1151, is_gfx1152,
            is_gfx1200, is_gfx1201,
            is_gfx940, is_gfx941, is_gfx942,
            is_gcn5, is_cdna1, is_rdna1, is_rdna1p1, is_rdna2,
            is_rdna3, is_rdna3_dgpu, is_rdna3p5, is_rdna4, is_cdna3,
            has_wmma, has_wmma_w32, has_wmma_w32_gfx12, has_dot2_f32_f16,
            has_mmq, is_gcn5_wave64, is_wave32, is_wave64_native,
            has_hfq3_sdot4, has_hfq3_dp4a, has_hfq3_mmq, has_hfq4_mmq,
            has_cdna3_lds_gemv,
            gemv_dp4a, gemv_prefetch, gemv_rows_default,
            flags,
        }
    }

    pub fn should_use_mmq(&self, batch_size: usize) -> bool {
        if !self.has_mmq { return false; }
    ...
    pub fn is_gfx1010(&self) -> bool { self.is_gfx1010 }
    pub fn is_gfx1011(&self) -> bool { self.is_gfx1011 }
    pub fn is_gfx1012(&self) -> bool { self.is_gfx1012 }
    pub fn is_gfx1030(&self) -> bool { self.is_gfx1030 }
    pub fn is_gfx1031(&self) -> bool { self.is_gfx1031 }
    pub fn is_gfx1032(&self) -> bool { self.is_gfx1032 }
    pub fn is_gfx1100(&self) -> bool { self.is_gfx1100 }
    pub fn is_gfx1101(&self) -> bool { self.is_gfx1101 }
    pub fn is_gfx1102(&self) -> bool { self.is_gfx1102 }
    pub fn is_gfx1103(&self) -> bool { self.is_gfx1103 }
    pub fn is_gfx1150(&self) -> bool { self.is_gfx1150 }
    pub fn is_gfx1151(&self) -> bool { self.is_gfx1151 }
    pub fn is_gfx1152(&self) -> bool { self.is_gfx1152 }
    pub fn is_gfx1200(&self) -> bool { self.is_gfx1200 }
    pub fn is_gfx1201(&self) -> bool { self.is_gfx1201 }
    pub fn is_gfx940(&self) -> bool { self.is_gfx940 }
    pub fn is_gfx941(&self) -> bool { self.is_gfx941 }
    pub fn is_gfx942(&self) -> bool { self.is_gfx942 }

    // ── Molecules ─────────────────────────────────────────────────
    pub fn is_gcn5(&self) -> bool { self.is_gcn5 }
    pub fn is_cdna1(&self) -> bool { self.is_cdna1 }
    pub fn is_rdna1(&self) -> bool { self.is_rdna1 }
    pub fn is_rdna1p1(&self) -> bool { self.is_rdna1p1 }
    pub fn is_rdna2(&self) -> bool { self.is_rdna2 }
    pub fn is_rdna3(&self) -> bool { self.is_rdna3 }
    pub fn is_rdna3_dgpu(&self) -> bool { self.is_rdna3_dgpu }
    pub fn is_rdna3p5(&self) -> bool { self.is_rdna3p5 }
    pub fn is_rdna4(&self) -> bool { self.is_rdna4 }
    pub fn is_cdna3(&self) -> bool { self.is_cdna3 }

    // ── Capabilities ──────────────────────────────────────────────
    pub fn has_wmma(&self) -> bool { self.has_wmma }
    pub fn has_wmma_w32(&self) -> bool { self.has_wmma_w32 }
    pub fn has_wmma_w32_gfx12(&self) -> bool { self.has_wmma_w32_gfx12 }
    pub fn has_dot2_f32_f16(&self) -> bool { self.has_dot2_f32_f16 }
    pub fn has_mmq(&self) -> bool { self.has_mmq }
    pub fn is_gcn5_wave64(&self) -> bool { self.is_gcn5_wave64 }
    pub fn is_wave32(&self) -> bool { self.is_wave32 }
    pub fn is_wave64_native(&self) -> bool { self.is_wave64_native }
    pub fn has_hfq3_sdot4(&self) -> bool { self.has_hfq3_sdot4 }
    pub fn has_hfq3_dp4a(&self) -> bool { self.has_hfq3_dp4a }
    pub fn has_hfq3_mmq(&self) -> bool { self.has_hfq3_mmq }
    pub fn has_hfq4_mmq(&self) -> bool { self.has_hfq4_mmq }
    pub fn has_cdna3_lds_gemv(&self) -> bool { self.has_cdna3_lds_gemv }
...
mod tests {
    ...
    fn gfx_atoms_exclusive() {
        ...
        for &arch in &all_gfxs {
            ...
            let count = [
                caps.is_gfx906(), caps.is_gfx908(),
                caps.is_gfx1010(), caps.is_gfx1011(), caps.is_gfx1012(),
                caps.is_gfx1030(), caps.is_gfx1031(), caps.is_gfx1032(),
                caps.is_gfx1100(), caps.is_gfx1101(), caps.is_gfx1102(), caps.is_gfx1103(),
                caps.is_gfx1150(), caps.is_gfx1151(), caps.is_gfx1152(),
                caps.is_gfx1200(), caps.is_gfx1201(),
                caps.is_gfx940(), caps.is_gfx941(), caps.is_gfx942(),
            ].iter().filter(|&&v| v).count();
            assert_eq!(count, 1, "expected exactly 1 atom true for {arch}, got {count}");
        }
    }
    ...
    #[test]
    fn dot2_coverage() {
        for arch in &["gfx1100", "gfx1101", "gfx1102", "gfx1150", "gfx1151", "gfx1152", "gfx1200", "gfx1201", "gfx1030", "gfx1031", "gfx1032", "gfx1011", "gfx1012"] {
