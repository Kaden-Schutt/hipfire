...
//! `hipfire_quantize::qtip` so this stays a self-contained rdna-compute example.
//!
//!   cargo run --release -p rdna-compute --example parity_qtip_viterbi_encode [n_groups bits beam]
