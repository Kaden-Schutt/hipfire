...
use hipfire_generate::{
    ...
    GenerateBatchPrefillEnvelope, GenerateVLParams, ImageSource, Qwen35DecodeBatchBackend,
    Qwen35DecodeBatchStepResult, Qwen35DecodeTokenOutcome,
};
...
mod events;
use events::{
    emit_committed_event, emit_error_with_id, emit_filter_action, write_error,
...
mod generate_batch_prefill_tests {
    ...
    use hipfire_generate::{
        ...
        plan_generate_batch_prefill_qwen35, qwen35_fused_prefill_boundary_cuts,
        qwen35_prefill_scratch_target_batch, select_qwen35_prefill_batch_backend,
        validate_qwen35_fused_grouped_moe_prefill_batch_preflight, GenerateBatchPrefillPlan,
        Qwen35FusedDensePrefillInputKind, Qwen35PrefillBatchBackend, Qwen35PreparedPrefillSession,
