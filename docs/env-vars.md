...
| `HIPFIRE_BF16_DENSE_M128` | Enabled by default; set to 0 to disable | `/home/sadara/.hipfire/src/crates/rdna-compute/src/dispatch.rs:42726` |
| `HIPFIRE_BF16_MOE_M256` | Enabled when set to 1 | `/home/sadara/.hipfire/src/crates/rdna-compute/src/dispatch.rs:21853` |
...
| `HIPFIRE_BLOB_FORCE` | Graph / capture / deterministic | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:234` |
...
| `HIPFIRE_CHAT_TEMPLATE_FILE` | 1. Env-var override | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:8963` |
...
| `HIPFIRE_DAEMON_RESIDENT_STATE_BUDGET_MB` | Runtime variable controlling daemon resident state budget mb in hipfire | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:3998` |
...
| `HIPFIRE_DEEPSEEK4_CACHE_TRACE` | Runtime variable controlling deepseek4 cache trace in hipfire | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:15061` |
...
| `HIPFIRE_DEEPSEEK4_DUMP_PROMPT` | Runtime variable controlling deepseek4 dump prompt in hipfire | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:14411` |
...
| `HIPFIRE_DEEPSEEK4_PP_BATCH` | B=1024 default (bumped from 16 on 2026-05-26). Sweep at 2.1k tokens: | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:9474` |
...
| `HIPFIRE_DEEPSEEK4_SEED` | Runtime variable controlling deepseek4 seed in hipfire | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:14635` |
| `HIPFIRE_DEEPSEEK4_SPEC_DECODE` | Speculative decode opt-in. Default off because at current DeepSeek V4 MQ2-Lloyd | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:14433` |
| `HIPFIRE_DEEPSEEK4_SPEC_K` | Runtime variable controlling deepseek4 spec k in hipfire | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:14441` |
...
| `HIPFIRE_DEEPSEEK4_TOP_K` | for local deployment; we honor that as the default. Pure greedy | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:14631` |
...
| `HIPFIRE_DEEPSEEK4_WO_Q8_WMMA` | Runtime variable controlling deepseek4 wo Q8 wmma in hipfire | `/home/sadara/.hipfire/src/crates/rdna-compute/src/dispatch.rs:47790` |
...
| `HIPFIRE_DETERMINISTIC` | Enabled when set to 1 | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:236` |
...
| `HIPFIRE_DUMMY_GENERATE_DELAY_MS` | Parses "HIPFIRE_DUMMY_GENERATE_DELAY_MS" with fallback defaults | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:417` |
| `HIPFIRE_DUMMY_PREFILL_DELAY_MS` | Parses "HIPFIRE_DUMMY_PREFILL_DELAY_MS" with fallback defaults | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:409` |
...
| `HIPFIRE_EMIT_TOKEN_IDS` | or "\" in it would corrupt the line, breaking the client's JSONL | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:602` |
...
| `HIPFIRE_EXPERIMENTAL_BUDGET_ALERT` | cache so the model "sees" them as part of its own trajectory, | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:7674` |
...
| `HIPFIRE_FUSED_HFQ4_2ROW_GFX1151` | Opt-in ("1") gfx1151 two-row fused HFQ4 decode probe for QKV/QKVZA; default off after flat A3B/9B measurements | `/home/sadara/.hipfire/src/crates/rdna-compute/src/dispatch.rs:24066` |
...
| `HIPFIRE_GDN_Q8_REG_GFX1151` | Opt-in ("1") gfx1151 register-state GDN Q8 probe; default off after A3B pp256 prefill regressed 11.8 ms to 168.5 ms total GDN time | `/home/sadara/.hipfire/src/crates/rdna-compute/src/dispatch.rs:38439` |
| `HIPFIRE_GEMM_DUMP` | Enabled when set to 1 | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:235` |
| `HIPFIRE_GEMV_ROWS` | Runtime variable controlling gemv rows in hipfire | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:138` |
...
| `HIPFIRE_GENERATE_BATCH_PREFILL_DEBUG_SAMPLE` | Runtime variable controlling generate batch prefill debug sample in hipfire | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:5607` |
| `HIPFIRE_GFX942_GEMV_V3` | Interprets "HIPFIRE_GFX942_GEMV_V3" from environment to select behavior | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:198` |
| `HIPFIRE_GFX942_MFMA_PREFILL` | Interprets "HIPFIRE_GFX942_MFMA_PREFILL" from environment to select behavior | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:201` |
| `HIPFIRE_GFX942_RMSNORM_SPLIT` | Environment toggle value controls runtime behavior | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:200` |
...
| `HIPFIRE_GQA_CHUNK` | Runtime variable controlling gqa chunk in hipfire | `/home/sadara/.hipfire/src/crates/rdna-compute/src/dispatch.rs:31017` |
...
| `HIPFIRE_HFQ4_QKVZA_FAST` | HIPFIRE_HFQ4_QKVZA_FAST=0 narrows the FP16/WMMA/dot2 prefill | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:174` |
| `HIPFIRE_HFQ4_RESIDUAL_FAST` | HIPFIRE_HFQ4_RESIDUAL_FAST=0 narrows the residual-projection | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:178` |
...
| `HIPFIRE_HFQ6_QKV_4W` | Interprets "HIPFIRE_HFQ6_QKV_4W" from environment to select behavior | `/home/sadara/.hipfire/src/crates/rdna-compute/src/dispatch.rs:26906` |
| `HIPFIRE_HFQ6_RESIDUAL_4W` | Interprets "HIPFIRE_HFQ6_RESIDUAL_4W" from environment to select behavior | `/home/sadara/.hipfire/src/crates/rdna-compute/src/dispatch.rs:25760` |
| `HIPFIRE_HIPCC_EXTRA_FLAGS` | Parses "HIPFIRE_HIPCC_EXTRA_FLAGS" with fallback defaults | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:261` |
...
| `HIPFIRE_JINJA_CHAT` | Enabled when set to 1 | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:15662` |
...
| `HIPFIRE_KV_PHYSICAL_CAP` | Parses "HIPFIRE_KV_PHYSICAL_CAP" with fallback defaults | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:9251` |
...
| `HIPFIRE_LLOYD_FORCE_BASELINE` | Runtime variable controlling lloyd force baseline in hipfire | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:252` |
...
| `HIPFIRE_LM_HEAD_OVERWRITE` | Environment toggle value controls runtime behavior | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:172` |
| `HIPFIRE_LM_HEAD_WMMA` | Runtime variable controlling lm head wmma in hipfire | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:170` |
...
| `HIPFIRE_MMQ` | Selects behavior from recognized values | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:160` |
| `HIPFIRE_MMQ_DIAG_QUANTIZE_ONLY` | Runtime variable controlling mmq diag quantize only in hipfire | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:183` |
| `HIPFIRE_MMQ_SCREEN` | Runtime variable controlling mmq screen in hipfire | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:175` |
| `HIPFIRE_MMQ_SCREEN_THRESHOLD` | Runtime variable controlling mmq screen threshold in hipfire | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:179` |
...
| `HIPFIRE_MOE_GROUPED_I8` | Run FP16 reference (i8 disabled) | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:203` |
| `HIPFIRE_MOE_GROUPED_I8_4W` | Experimental gfx1151 HFQ4 grouped MoE k8 4w variant; default off after A3B/122B regression vs k8 | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:208` |
| `HIPFIRE_MOE_GROUPED_I8_K4` | Opt-in gfx1151 HFQ4 grouped MoE k4 variant; use with "HIPFIRE_MOE_GROUPED_I8_K8=0". Default off after 122B pp64 measured slower than k8 | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:219` |
| `HIPFIRE_MOE_GROUPED_I8_K4_GFX12` | Runtime variable controlling moe grouped i8 k4 gfx12 in hipfire | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:220` |
| `HIPFIRE_MOE_GROUPED_I8_K8` | gfx1151 HFQ4 grouped MoE k8 control: default on for gfx1151, set to 0 to test k4 or base k2 variants | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:214` |
| `HIPFIRE_MOE_GROUPED_M2` | Run m2 kernel (env set) | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:222` |
| `HIPFIRE_MOE_HFQ6_4W` | Default ON for gfx1151 HFQ6 grouped MoE; set to 0 to use the older v1/v2 path | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:230` |
| `HIPFIRE_MOE_HFQ6_V2` | Opt-in HFQ6 grouped MoE v2 path; on gfx1151 it only routes when "HIPFIRE_MOE_HFQ6_4W=0" and remains slower than the default 4w path on 122B pp64 | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:226` |
| `HIPFIRE_MOE_INDEXED_2ROW_GFX1151` | Opt-in ("1") gfx1151 two-row indexed MoE HFQ4 decode probe for gate/up and expanded down; default off after flat A3B measurements | `/home/sadara/.hipfire/src/crates/rdna-compute/src/dispatch.rs:24084` |
...
| `HIPFIRE_MW16` | Runtime variable controlling mw16 in hipfire | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:237` |
...
| `HIPFIRE_PFLASH_DEBUG` | Runtime variable controlling pflash debug in hipfire | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:12947` |
...
| `HIPFIRE_PP_DFLASH` | Environment toggle value controls runtime behavior | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:7139` |
...
| `HIPFIRE_PP_PFLASH` | Environment toggle value controls runtime behavior | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:7157` |
...
| `HIPFIRE_PREFILL_MAX_BATCH` | Runtime variable controlling prefill max batch in hipfire | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:6351` |
...
| `HIPFIRE_PREFIX_BOUNDARY_CHECKPOINTS` | Interprets "HIPFIRE_PREFIX_BOUNDARY_CHECKPOINTS" from environment to select behavior | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:4829` |
...
| `HIPFIRE_Q8_WMMA_4W` | originally shipped default-ON on gfx11/gfx12, but the auto-enable | `/home/sadara/.hipfire/src/crates/rdna-compute/src/dispatch.rs:28519` |
| `HIPFIRE_Q8_WMMA_X64` | Environment toggle value controls runtime behavior | `/home/sadara/.hipfire/src/crates/rdna-compute/src/dispatch.rs:28330` |
...
| `HIPFIRE_QWEN35_DECODE_BATCH` | Defaults to auto when unset | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:5964` |
| `HIPFIRE_QWEN35_DECODE_BATCH_MAX` | Runtime variable controlling qwen35 decode batch max in hipfire | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:6061` |
| `HIPFIRE_QWEN35_DECODE_INTERNAL_PARITY` | Interprets "HIPFIRE_QWEN35_DECODE_INTERNAL_PARITY" from environment to select behavior | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:6080` |
| `HIPFIRE_QWEN35_DECODE_NATIVE_MULTIROW` | Interprets "HIPFIRE_QWEN35_DECODE_NATIVE_MULTIROW" from environment to select behavior | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:6071` |
...
| `HIPFIRE_QWEN35_PREFILL_SESSION_BATCH` | Runtime variable controlling qwen35 prefill session batch in hipfire | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:5709` |
...
| `HIPFIRE_RDNA2_VARIANT` | Runtime variable controlling rdna2 variant in hipfire | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:256` |
...
| `HIPFIRE_SERVER_RESIDENT_STATE_BUDGET_MB` | Runtime variable controlling server resident state budget mb in hipfire | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:3999` |
...
| `HIPFIRE_WO_MMQ` | Enabled when set to 1 | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:169` |
| `HIPFIRE_WO_WMMA_VARIANT` | Runtime variable controlling wo wmma variant in hipfire | `/home/sadara/.hipfire/src/crates/rdna-compute/src/feature_flags.rs:243` |
...
| `USERPROFILE` | Runtime variable controlling userprofile in hipfire | `/home/sadara/.hipfire/src/crates/hipfire-daemon/src/main.rs:648` |
