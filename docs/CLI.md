...
RGB conversion, but full generation is not routed through a GPU UNet runtime
yet.
...
f32 dense linear projection, and RGB conversion. Each kernel probe is checked
