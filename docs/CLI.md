...
RGB conversion, but full generation is not routed through a GPU UNet runtime yet.
...
self-attention, GeGLU gate, and RGB conversion. Each kernel probe is checked
