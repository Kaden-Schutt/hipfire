...
|---|---|---|---|
| Build | `cargo build --release -p hipfire-rdna --example parity_causal_wmma -p hipfire-arch-qwen2 --example infer_qwen2 -p hipfire-arch-dots-ocr --example ocr_e2e` | PASS | Built on `hiptrx` before model smokes. Existing repo warnings only. |
