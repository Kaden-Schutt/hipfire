...
# cross-arch seed levers (box-local file; only present for arches we choose to seed)
seed = ""
if os.path.exists("/tmp/crossarch_seeds.txt"):
    seed = open("/tmp/crossarch_seeds.txt").read().strip() + "\n\n"
print(seed + "\n".join(lines))
