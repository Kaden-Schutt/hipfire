// Shared body for HFQ3-G256 wave32 MMQ 4-way fused (LA preamble) GEMM.
//
// Routes per workgroup to one of: wqkv / wz / w_beta / w_alpha. Used by
// the dense LinearAttention preamble in Qwen3.5 / Qwen3.5-VL.
//
// CALLER INVARIANT: qkv_m, z_m, beta_m, alpha_m must each be a multiple
// of MMQ_Y=128. Qwen3.5 family satisfies this.
//
// Same LDS-tiled X reuse + sdot4 inner loop as the qkv / gate_up bodies.
