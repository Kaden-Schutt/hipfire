...
if [ ! -f "$V4F_MODEL" ]; then
    {
        ...
        echo "  ln -s /data/hipfire-models/deepseek-v4-flash-lloyd-mq2.hfq \\"
        echo "        \"\$HOME/.hipfire/models/deepseek-v4-flash-lloyd-mq2.hfq\""
        echo "  ln -s /data/hipfire-models/deepseek-v4-flash-mtp-lloyd-mq2.hfq \\"
        echo "        \"\$HOME/.hipfire/models/deepseek-v4-flash-mtp-lloyd-mq2.hfq\""
    } > "$OUT"
